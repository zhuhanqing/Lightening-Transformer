# -*- coding: utf-8 -*-
# @Author: Hanqing Zhu
# @Date:   2022-11-30 21:32:37
# @Last Modified by:   Hanqing Zhu(hqzhu@utexas.edu)
# @Last Modified time: 2023-11-09 17:11:56
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/local/eda02/ImageNet/data/', type=str,
                        help='dataset path')
